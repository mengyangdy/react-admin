...
const ChromeTab = ({
	...
	return (
		...
		>
			<div
				className={classNames(":dy: pointer-events-none absolute left-0 top-0 w-full -z-1", [
			...
			{suffix}
			<div
				className={classNames(":dy: absolute right-7px h-16px w-1px bg-#1f2225", [
					styles["chrome-tab-divider"],
				])}
			/>
		</div>
	);
